...
class Appmerce_Epdq_Controller_Common extends Mage_Core_Controller_Front_Action
{
    /**
    ...
    {
        $this->getCheckout()->setePDQQuoteId($this->getCheckout()->getLastSuccessQuoteId());
        $this->getCheckout()->setePDQOrderId($this->getCheckout()->getLastOrderId());
    }
