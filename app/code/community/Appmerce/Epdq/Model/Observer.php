 ...
 * http://opensource.org/licenses/osl-3.0.php * @package     Appmerce_Epdq
 * @copyright   Copyright (c) 2011-2014 Appmerce (http://www.appmerce.com)
 * @license     http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */

class Appmerce_Epdq_Model_Observer
{
    /**
     * Convert specific attributes from Quote Payment to Order Payment
     *
     * @param Varien_Object $observer
     * @return Appmerce_IdealAdvanced_Model_Observer
     */
    public function convertPayment($observer)
    {
        ...
        $orderPayment->setePDQIssuerId($quotePayment->getePDQIssuerId());
